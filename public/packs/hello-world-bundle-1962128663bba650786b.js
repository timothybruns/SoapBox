...
throw new Error("Module build failed: SyntaxError: Adjacent JSX elements must be wrapped in an enclosing tag (9:22)\n\n   7 |       {bookData.map((book, index) => (\n   8 |         <p key={index}>Title: {book.title}</p>\n>  9 |                       <p> Author: {book.author} </p>\n     |                       ^\n  10 |         ))}\n  11 |     </div>\n  12 |     ) : (\n");

/***/ })
/******/ ]);
//# sourceMappingURL=hello-world-bundle-1962128663bba650786b.js.map