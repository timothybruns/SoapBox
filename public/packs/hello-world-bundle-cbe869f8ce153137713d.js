...
throw new Error("Module build failed: SyntaxError: Unexpected token, expected , (8:20)\n\n   6 |       <h1> This is content </h1>\n   7 |       {bookData.map((book, index) => (\n>  8 |         key={index} {book.title} {book.author}\n     |                     ^\n   9 |         ))}\n  10 |     </div>\n  11 |     );\n");

/***/ })
/******/ ]);
//# sourceMappingURL=hello-world-bundle-cbe869f8ce153137713d.js.map