...
throw new Error("Module build failed: SyntaxError: Unexpected token, expected , (8:23)\n\n   6 |       {bookData.map((book, index) => (\n   7 |         <p key={index}>Title: {book.title} </p>\n>  8 |                        Author: {book.author} </p>\n     |                        ^\n   9 |         ))}\n  10 |     </div>\n  11 |     ) : (\n");

/***/ })
/******/ ]);
//# sourceMappingURL=hello-world-bundle-fbc85e9c9bf1b5ca4b86.js.map