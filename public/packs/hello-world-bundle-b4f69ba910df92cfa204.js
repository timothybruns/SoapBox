  ...
  _createClass(App, [{
    ...
    value: function render() {
      return __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement(
        ...
        __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_4__Content__["default"], {
...
throw new Error("Module build failed: SyntaxError: Adjacent JSX elements must be wrapped in an enclosing tag (8:8)\n\n   6 |       {bookData.map((book, index) => (\n   7 |         <p key={index}>Title: {book.title} </p>\n>  8 |         <p key= {index}> Author: {book.author}</p>\n     |         ^\n   9 |         ))}\n  10 |     </div>\n  11 |     ) : (\n");

/***/ })
/******/ ]);
//# sourceMappingURL=hello-world-bundle-b4f69ba910df92cfa204.js.map